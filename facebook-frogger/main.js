...
var novax = new Image();
novax.src = "../images/novax.png";
var c = new Image();
c.src = "../images/pixmom.png";
var trump = new Image();
trump.src = "../images/elderberry.png";
var fnews = new Image();
...
Sprite.prototype.render = function() {
  ...
  if (this.shape === 'rect') {
  ...
  else if (this.shape === 'rect1'){
    context.drawImage(novax,this.x, this.y + gridGap / 2, this.size, grid - gridGap);
  }

  else if (this.shape == 'charac'){
    context.drawImage(c, this.x, this.y + gridGap / 2, this.size, grid - gridGap);
  }
    ...
    context.drawImage(bshapiro, this.x , this.y + gridGap / 2, this.size , grid - gridGap);
  }
    ...
    context.drawImage(ajones, this.x , this.y + gridGap / 2, this.size , grid - gridGap);
  }
